        ...
        <div class="row my-3">
            <div class="col-md">
                ...
                <form action="./Main" method="post">
                    <div class="form-row">
                        <div class="col">
                            <input type="date" name="expirationDate" value="<c:out value="${today}" />" class="form-control" required>
                        </div>
                        <div class="col-6">
                            <input type="text" name="todoItem" class="form-control" required>
                        </div>
                        <div class="col">
...
<!--                            </td>-->
                            <td class="text-nowrap text-right" style='color: black;'>
